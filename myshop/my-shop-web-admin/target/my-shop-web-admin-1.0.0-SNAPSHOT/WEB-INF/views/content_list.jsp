                            ...
                            <div class="row form-horizontal">
                                ...
                                <div class="col-xs-3 col-sm-3">
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-8">
                                            <input id="subTitle" class="form-control" placeholder="请输入副标题">
                    ...
                    <div class="box">
                        ...
                        <div class="box-body">
                            <div style="padding-left: 17px;padding-top: 5px;" class="row ">
                                ...
                                <a href="/content/from" type="button" class="btn btn-primary"><i class=" fa fa-plus"></i>新增</a>&nbsp&nbsp
                                <a type="button" class="btn btn-danger" onclick="App.deleteMulti('/content/delete')"><i class=" fa fa-trash"></i>批量删除</a>&nbsp&nbsp
